...
class EditTokoPresenter (val contract: EditTokoContract){
    ...
    fun editToko(uploaded_file_toko: String, uploaded_file_ktp: String, tokoID: String, tokoNama: String, tokoWilayah: String, tokoAlamat: String, tokoStatus: String, tokoPicName: String, tokoPicPhone: String, tokoMapLat: String, tokoMapLong: String, progressBar: ProgressBar){
