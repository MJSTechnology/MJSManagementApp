package com.project.mjsmanagementapp.adapter.transaksi.jual
...
class ListSellCategoryTokoAdapter(val data: List<ResponseListTrcSellCategoryTokoItem>?, val click: ListSellCategoryTokoAdapter.onClickItem):RecyclerView.Adapter<ListSellCategoryTokoAdapter.ViewHolder>() {
